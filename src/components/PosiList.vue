...
<!--      &lt;!&ndash; get by calculation     &ndash;&gt;-->
<!--      <el-table-column label="成本" align="center"-->
<!--                       :formatter="costFormatter"/>-->
<!--    </el-table>-->

<!--    &lt;!&ndash; 分页控件 刷新按钮&ndash;&gt;-->
...
export default {
  ...
  data() {
    return {
      tableData: [
        {code: '600025', name: 'ABC', count: 100, cost: 20},
        {code: '600000', name: 'XXX', count: 100, cost: 20},
        {code: '600088', name: 'YYY', count: 100, cost: 20},
      ],
      balance: 0,
