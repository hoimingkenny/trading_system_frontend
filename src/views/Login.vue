      ...
      <el-row>
        ...
        <el-col :span="12">
          <el-form-item prop="captcha">
            <el-row>
              <el-input v-model="ruleForm.captcha" type="text" auto-complete="off" placeholder="Verification Code"/>
            </el-row>
          </el-form-item>
        </el-col>
        <!-- Verification Image -->
  ...
  export default {
    ...
    data() {
      return {
        ...
        // 2. Verification Code Image
        codeImg: '',
        // 3. Validation
        rules: {
          uid: [{required: true, message: 'Please input username', trigger: 'blur'}],
          password: [{required: true, message: 'Please input password', trigger: 'blur'}],
          captcha: [{required: true, message: 'Please input verification code', trigger: 'blur'}],
        },
